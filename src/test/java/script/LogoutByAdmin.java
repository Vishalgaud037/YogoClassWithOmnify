...
public class LogoutByAdmin extends BaseTest {

	@Test
	public void ClickOnLogout() throws EncryptedDocumentException, FileNotFoundException, IOException {
		...
		hPage.ClickOnLogoutOpt();
		// click on logout button
		hPage.ClickOnLogout();

		boolean result1 = login.verifyLoginPageIsDisplayed(wait);
